...
func TestSupportsBackupType(t *testing.T) {
	tests := []struct {
		...
		{name: "mysql physical", dbType: DBTypeMySQL, backupType: DatabaseBackupTypePhysical, want: true},
		{name: "mysql custom", dbType: DBTypeMySQL, backupType: DatabaseBackupTypeLogicalCustom, want: false},
		{name: "mariadb physical", dbType: DBTypeMariaDB, backupType: DatabaseBackupTypePhysical, want: true},
